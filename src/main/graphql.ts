	...
	buildResolvers<TSource>(): IResolvers<TSource, IContext> {
		...
		return mergeResolvers([{
			...
			Query: {
				...
				clinicalCareStateWithClinicCares: clinicalCareState.clinicalCareStateWithClinicCares,
			...
			Mutation: {
				...
				upgradeMedication: medication.upgradeMedication,
				downgradeMedication: medication.downgradeMedication,
